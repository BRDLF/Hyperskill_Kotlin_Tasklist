...
class TaskList {
    ...
    private fun makeTask() {
        ...
        val taskToAdd = Task(taskDate = date, taskTime = time, taskPriority = priority, taskDescription = description)
    ...
    data class Task(val taskPriority: String = "N", val taskDate: String, private val taskTime: String, val taskDescription: List<String>) {
        ...
        fun printTask(listIndex: Int) {
            ...
            for (taskIndex in newTaskDesc.indices) {
                if (taskIndex == 0) {
                    println(newFormat.format(listIndex + 1, taskDate, taskTime, priorityTag(), dueTag(), newTaskDesc[taskIndex]))
                }
